  ...
  return (
    ...
    <section className='w-full nav-heigth' id="Hero">
        <div className='flex size-full flex-center flex-col'>
            ...
            <div className=" flex flex-col px-10 font-semibold md:relative text-center">
                ...
                <p className=" cursor-default font-semibold text-lg">"London base cross-functional collaborator with strong foundation in multiple areas."</p>
